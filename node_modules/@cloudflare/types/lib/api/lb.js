...
exports.OriginGroup = exports.OriginData = exports.Origin = exports.LoadBalancerUsage = exports.LoadBalancerRuleOverrides = exports.LoadBalancerRule = exports.LoadBalancerPool = exports.LoadBalancerMonitor = exports.LoadBalancer = exports.HealthGroup = exports.HealthData = void 0;
...
var Origin = _utilEnGarde.eg.object({
  ...
  virtual_network_id: _utilEnGarde.eg.string.optional,
...
var LoadBalancerPool = _utilEnGarde.eg.object({
  ...
  origin_steering: _utilEnGarde.eg.object({
    policy: _utilEnGarde.eg.union([_utilEnGarde.eg.literal('random'), _utilEnGarde.eg.literal('hash'), _utilEnGarde.eg.literal('least_outstanding_requests'), _utilEnGarde.eg.literal('least_connections')])
  }).optional,
...
var SteeringPolicy = _utilEnGarde.eg.union([_utilEnGarde.eg.literal('off'), _utilEnGarde.eg.literal('dynamic_latency'), _utilEnGarde.eg.literal('geo'), _utilEnGarde.eg.literal('random'), _utilEnGarde.eg.literal('gps'), _utilEnGarde.eg.literal('proximity'), _utilEnGarde.eg.literal('least_outstanding_requests'), _utilEnGarde.eg.literal('least_connections')]).optional;
var LoadBalancerRuleOverrides = _utilEnGarde.eg.object({
  session_affinity: _utilEnGarde.eg.union([_utilEnGarde.eg.literal('none'), _utilEnGarde.eg.literal('cookie'), _utilEnGarde.eg.literal('ip_cookie'), _utilEnGarde.eg.literal('header')]).optional,
  session_affinity_ttl: _utilEnGarde.eg.number.optional,
  session_affinity_attributes: _utilEnGarde.eg.object({
    headers: _utilEnGarde.eg.array(_utilEnGarde.eg.string).optional,
    require_all_headers: _utilEnGarde.eg.boolean.optional
  }).optional,

...
exports.ZoneUIConfig = exports.ZoneType = exports.ZonePlan = exports.ZoneOwner = exports.ZoneMeta = exports.ZoneHold = exports.ZoneBlock = exports.ZoneAccount = exports.Zone = exports.SelectedZonePlan = exports.AbuseUrl = void 0;
...
var Zone = _utilEnGarde.eg.object({
  id: _utilEnGarde.eg.string,
  name: _utilEnGarde.eg.string,
  versioning: _utilEnGarde.eg.object({
    enabled: _utilEnGarde.eg.boolean,
    isRoot: _utilEnGarde.eg.boolean,
    version: _utilEnGarde.eg.number,
    rootZoneId: _utilEnGarde.eg.string
  }).optional,
...
var ZoneBlock = _utilEnGarde.eg.object({
  ...
  url_query: _utilEnGarde.eg.array(_utilEnGarde.eg.object({
    key: _utilEnGarde.eg.string,
    value: _utilEnGarde.eg.string
  })).optional,
  url_query_string: _utilEnGarde.eg.string.optional,

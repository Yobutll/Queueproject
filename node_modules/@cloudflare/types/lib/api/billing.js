...
exports.PlanName = exports.PaymentMethodType = exports.PaymentMethodList = exports.PaymentMethod = exports.PaymentGateway = exports.DeviceDetails = exports.BillingTransaction = exports.BillingQuote = exports.BillingProfile = exports.BillingPlan = exports.BillingPayment = exports.BillingAddress = exports.BillingAccountType = exports.BillingAccountCredits = exports.BillingAccount = exports.BillableUsageTimeDelta = exports.BillableUsageMetric = exports.BillableUsage = exports.BFResponse = exports.AddressValidation = void 0;
...
var PaymentMethodType = _utilEnGarde.eg.union([_utilEnGarde.eg.literal('PAYPAL'), _utilEnGarde.eg.literal('CREDIT_CARD'), _utilEnGarde.eg.literal('APPLE_PAY'), _utilEnGarde.eg.literal('GOOGLE_PAY'), _utilEnGarde.eg.literal('ACH_DIRECT_DEBIT'), _utilEnGarde.eg.literal('SEPA_DEBIT'), _utilEnGarde.eg.literal('CASHAPP'), _utilEnGarde.eg.literal('LINK')]);
...
var PaymentMethod = _utilEnGarde.eg.object({
  ...
  bank_name: _utilEnGarde.eg.string.optional,
  payment_account_email: _utilEnGarde.eg.string.optional,
  cashapp_cash_tag: _utilEnGarde.eg.string.optional,
  expiration_date: _utilEnGarde.eg.string.optional,
  ...
  tax_id_type: _utilEnGarde.eg.string.optional,
  cf_turnstile_response: _utilEnGarde.eg.string.optional
});

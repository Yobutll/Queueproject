...
exports.GraphQLSettings = exports.GraphQLSetting = exports.GraphQLNodeName = void 0;
...
var GraphQLSetting = _utilEnGarde.eg.object({
  enabled: _utilEnGarde.eg.boolean,
  maxDuration: _utilEnGarde.eg.number,
  maxNumberOfFields: _utilEnGarde.eg.number.optional,
  maxPageSize: _utilEnGarde.eg.number,
  notOlderThan: _utilEnGarde.eg.number,
  availableFields: _utilEnGarde.eg.array(_utilEnGarde.eg.string).optional
});
exports.GraphQLSetting = GraphQLSetting;
var GraphQLSettings = _utilEnGarde.eg.record(GraphQLNodeName, GraphQLSetting);
exports.GraphQLSettings = GraphQLSettings;
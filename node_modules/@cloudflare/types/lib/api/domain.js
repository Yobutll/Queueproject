...
exports.SupportedTLDs = exports.ResendDomainProtectionEmailRequest = exports.RegistrationStatus = exports.RegistrationSettings = exports.RegistrantContacts = exports.RegistrantContact = exports.LandingSettings = exports.GetDomainsResult = exports.DomainUpdateResult = exports.DomainSearchResult = exports.DomainProtectionStatus = exports.DomainProtectionPostResult = exports.DomainProtectionDesignatedApprovers = exports.DomainProtectionData = exports.DomainProtectionConfigStatus = exports.DomainProtectionConfig = exports.DomainFees = exports.DomainExists = exports.DomainEligibility = exports.Domain = exports.DesignatedApprover = exports.DefaultContactInformation = exports.ApproverStatus = void 0;
var _utilEnGarde = require("@cloudflare/util-en-garde");
var RegistrationStatus = _utilEnGarde.eg.union([_utilEnGarde.eg.literal('registrationPending'), _utilEnGarde.eg.literal('registrationPendingAuthorization'), _utilEnGarde.eg.literal('registrationPendingZoneCreate'), _utilEnGarde.eg.literal('registrationPendingRegister'), _utilEnGarde.eg.literal('registrationPendingZoneActivate'), _utilEnGarde.eg.literal('registrationPendingSettlement'), _utilEnGarde.eg.literal('registrationFailed'), _utilEnGarde.eg.literal('registrationFailedAuthorization'), _utilEnGarde.eg.literal('registrationFailedQuote'), _utilEnGarde.eg.literal('registrationFailedRegister'), _utilEnGarde.eg.literal('registrationFailedZoneCreate'), _utilEnGarde.eg.literal('registrationFailedZoneActivate'), _utilEnGarde.eg.literal('registrationFailedSettlement'), _utilEnGarde.eg.literal('registrationFailedDNSFatal'), _utilEnGarde.eg.literal('registrationFailedDNSError'), _utilEnGarde.eg.literal('registrationFailedDNSLandingCNameFatal'), _utilEnGarde.eg.literal('registrationFailedDNSLandingCNameError'), _utilEnGarde.eg.literal('restorationPending'), _utilEnGarde.eg.literal('restorationPendingZoneCreate'), _utilEnGarde.eg.literal('restorationPendingZoneActivate'), _utilEnGarde.eg.literal('restorationFailedZoneCreate'), _utilEnGarde.eg.literal('restorationFailedZoneActivate'), _utilEnGarde.eg.literal('restorationSuccess'), _utilEnGarde.eg.literal('restorationZoneCreateSuccess'), _utilEnGarde.eg.literal('restorationZoneActivateSuccess'), _utilEnGarde.eg.literal('restorationSuccessWithoutReport'), _utilEnGarde.eg.literal('transferFOAPending'), _utilEnGarde.eg.literal('transferPending'), _utilEnGarde.eg.literal('transferRejected'), _utilEnGarde.eg.literal('transferCancelled'), _utilEnGarde.eg.literal('transferOutPending'), _utilEnGarde.eg.literal('registrationActive'), _utilEnGarde.eg.literal('expiredParked'), _utilEnGarde.eg.literal('deletionInitiated'), _utilEnGarde.eg.literal('deletionIrredeemable'), _utilEnGarde.eg.literal('domainTerminated'), _utilEnGarde.eg.literal('domainFrozen')]);
...
var RegistrantContact = _utilEnGarde.eg.object({
  ...
  email_verified: _utilEnGarde.eg.boolean.optional,
  ...
  material_changes: _utilEnGarde.eg.array(_utilEnGarde.eg.string).optional,
...
var DomainProtectionStatus = /*#__PURE__*/function (DomainProtectionStatus) {
  ...
  return DomainProtectionStatus;
}({});
exports.DomainProtectionStatus = DomainProtectionStatus;
var Domain = _utilEnGarde.eg.object({
  administrator_contact_id: _utilEnGarde.eg.union([_utilEnGarde.eg.number, _utilEnGarde.eg.null]).optional,
  auth_code: _utilEnGarde.eg.string.optional,
  auto_renew: _utilEnGarde.eg.boolean.optional,
  available: _utilEnGarde.eg.boolean,
  billing_contact_id: _utilEnGarde.eg.union([_utilEnGarde.eg.number, _utilEnGarde.eg.null]).optional,
  can_register: _utilEnGarde.eg.boolean.optional,
  ...
  contacts: _utilEnGarde.eg.any.optional,
  contacts_updated_at: _utilEnGarde.eg.string.optional,
  cor_locked: _utilEnGarde.eg.boolean.optional,
  cor_locked_until: _utilEnGarde.eg.union([_utilEnGarde.eg.string, _utilEnGarde.eg.null]).optional,
  cor_responses_pending: _utilEnGarde.eg.number.optional,
  ...
  last_known_status: _utilEnGarde.eg.union([_utilEnGarde.eg.string, _utilEnGarde.eg.null]).optional,
  ...
  permissions: _utilEnGarde.eg.array(_utilEnGarde.eg.string).optional,
  previous_registrar: _utilEnGarde.eg.union([_utilEnGarde.eg.string, _utilEnGarde.eg.null]).optional,
  privacy: _utilEnGarde.eg.boolean.optional,
  registered_at: _utilEnGarde.eg.union([_utilEnGarde.eg.string, _utilEnGarde.eg.null]).optional,
  registrant_contact_id: _utilEnGarde.eg.union([_utilEnGarde.eg.number, _utilEnGarde.eg.null]).optional,
  ...
  technical_contact_id: _utilEnGarde.eg.union([_utilEnGarde.eg.number, _utilEnGarde.eg.null]).optional,
...
var ApproverStatus = /*#__PURE__*/function (ApproverStatus) {
...
var DomainProtectionConfigStatus = /*#__PURE__*/function (DomainProtectionConfigStatus) {
  ...
  return DomainProtectionConfigStatus;
}({});
...
var ResendDomainProtectionEmailRequest = /*#__PURE__*/function (ResendDomainProtectionEmailRequest) {
  ...
  return ResendDomainProtectionEmailRequest;
}({});
exports.ResendDomainProtectionEmailRequest = ResendDomainProtectionEmailRequest;
var SupportedTLDs = _utilEnGarde.eg.object({
  tlds: _utilEnGarde.eg.array(_utilEnGarde.eg.string)
});
exports.SupportedTLDs = SupportedTLDs;
var DomainUpdateResult = _utilEnGarde.eg.object({
  message: _utilEnGarde.eg.string
});

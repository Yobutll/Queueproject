...
exports.RatePlanId = exports.RatePlanDiscounts = exports.RatePlanComponentTier = exports.RatePlanComponent = exports.RatePlan = exports.ProductPlanId = exports.PlanId = exports.CfPlanId = void 0;
var _utilEnGarde = require("@cloudflare/util-en-garde");
var PlanId = _utilEnGarde.eg.union([_utilEnGarde.eg.literal('free'), _utilEnGarde.eg.literal('pro'), _utilEnGarde.eg.literal('business'), _utilEnGarde.eg.literal('enterprise'), _utilEnGarde.eg.literal('enterprise_trial'), _utilEnGarde.eg.literal('lite'), _utilEnGarde.eg.literal('pro_plus'), _utilEnGarde.eg.literal('partners_free'), _utilEnGarde.eg.literal('partners_pro'), _utilEnGarde.eg.literal('partners_biz'), _utilEnGarde.eg.literal('partners_ent')]);
exports.PlanId = PlanId;
var CfPlanId = _utilEnGarde.eg.union([_utilEnGarde.eg.literal('cf_biz'), _utilEnGarde.eg.literal('CF_BIZ'), _utilEnGarde.eg.literal('cf_biz_emp'), _utilEnGarde.eg.literal('CF_BIZ_EMP'), _utilEnGarde.eg.literal('cf_biz_free'), _utilEnGarde.eg.literal('CF_BIZ_FREE'), _utilEnGarde.eg.literal('cf_biz_galileo'), _utilEnGarde.eg.literal('CF_BIZ_GALILEO'), _utilEnGarde.eg.literal('cf_biz_plus'), _utilEnGarde.eg.literal('CF_BIZ_PLUS'), _utilEnGarde.eg.literal('cf_ent'), _utilEnGarde.eg.literal('CF_ENT'), _utilEnGarde.eg.literal('cf_ent_trial'), _utilEnGarde.eg.literal('CF_ENT_TRIAL'), _utilEnGarde.eg.literal('cf_free'), _utilEnGarde.eg.literal('CF_FREE'), _utilEnGarde.eg.literal('cf_pro_20_20'), _utilEnGarde.eg.literal('CF_PRO_20_20'), _utilEnGarde.eg.literal('cf_pro_20_5'), _utilEnGarde.eg.literal('CF_PRO_20_5'), _utilEnGarde.eg.literal('cf_pro_free'), _utilEnGarde.eg.literal('CF_PRO_FREE'), _utilEnGarde.eg.literal('cf_lite'), _utilEnGarde.eg.literal('CF_LITE'), _utilEnGarde.eg.literal('cf_pro_plus'), _utilEnGarde.eg.literal('CF_PRO_PLUS')]);
...
var RatePlanId = _utilEnGarde.eg.union([PlanId, CfPlanId, ProductPlanId]);
exports.RatePlanId = RatePlanId;
var RatePlanComponentTier = _utilEnGarde.eg.object({
  lowerThreshold: _utilEnGarde.eg.number,
  upperThreshold: _utilEnGarde.eg.number,
  pricingType: _utilEnGarde.eg.string,
  price: _utilEnGarde.eg.number,
  annual_price: _utilEnGarde.eg.number.optional,
  bucketSize: _utilEnGarde.eg.number
});
exports.RatePlanComponentTier = RatePlanComponentTier;
// BILL-17675 -- Support GRANDFATHER discount if hasInstallBaseCustomerFlag
//               This discount is available until May 15, 2023.
var RatePlanDiscounts = _utilEnGarde.eg.object({
  GRANDFATHER: _utilEnGarde.eg.array(RatePlanComponentTier)
});
exports.RatePlanDiscounts = RatePlanDiscounts;
var RatePlanComponent = _utilEnGarde.eg.object({
  name: _utilEnGarde.eg.string,
  publicName: _utilEnGarde.eg.string,
  type: _utilEnGarde.eg.string,
  key: _utilEnGarde.eg.string,
  chargeType: _utilEnGarde.eg.string,
  chargeModel: _utilEnGarde.eg.string,
  unitOfMeasure: _utilEnGarde.eg.string,
  defaultQuantity: _utilEnGarde.eg.number,
  cfStartOfFirstUnit: _utilEnGarde.eg.number,
  cfUsageDivisor: _utilEnGarde.eg.number,
  tiers: _utilEnGarde.eg.array(RatePlanComponentTier),
  discounts: RatePlanDiscounts
});
exports.RatePlanComponent = RatePlanComponent;
var RatePlan = _utilEnGarde.eg.object({
  id: RatePlanId,
  public_name: _utilEnGarde.eg.string,
  currency: _utilEnGarde.eg.literal('USD'),
  components: _utilEnGarde.eg.array(RatePlanComponent)
});

...
export var DNSRecordMeta = eg.object({
...
export var DNSRecord = eg.object({
  ...
  ttl: eg.number,
  type: eg.union([eg.literal('A'), eg.literal('AAAA'), eg.literal('CNAME'), eg.literal('CAA'), eg.literal('CERT'), eg.literal('DNSKEY'), eg.literal('DS'), eg.literal('HTTPS'), eg.literal('LOC'), eg.literal('MX'), eg.literal('NAPTR'), eg.literal('NS'), eg.literal('PTR'), eg.literal('SRV'), eg.literal('TXT'), eg.literal('SMIMEA'), eg.literal('SSHFP'), eg.literal('SVCB'), eg.literal('TLSA'), eg.literal('URI')]),
...
export var DNSFirewallCluster = eg.object({
  id: eg.string,
  name: eg.string,
...
export var DNSAcl = eg.object({
  id: eg.string,
  ip_range: eg.string,
  name: eg.string
});
export var DNSTsig = eg.object({
  id: eg.string,
  algo: eg.string,
  name: eg.string,
  secret: eg.string
});
export var DNSPeer = eg.object({
  name: eg.string,
  id: eg.string,
  ip: eg.string,
  port: eg.number,
...
export var ZonePeerConfig = eg.object({
  id: eg.string,
  name: eg.string,
...
export var DNSOutgoingZoneTransfers = eg.union([eg.literal('Enabled'), eg.literal('Disabled')]);
export var HostnameRegions = eg.array(eg.object({
  key: eg.string,
  label: eg.string
}));
export var RegionalHostname = eg.object({
  hostname: eg.string,
  region_key: eg.string
});
export var RegionalHostnames = eg.array(RegionalHostname);
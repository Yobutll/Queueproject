...
export var ZoneOwner = eg.object({
  id: eg.string,
  type: eg.string,
  email: eg.string
});
export var ZoneAccount = eg.object({
  id: eg.string,
  name: eg.string
});
export var ZoneType = eg.union([eg.literal('full'), eg.literal('partial'), eg.literal('secondary')]);
export var ZonePlan = eg.object({
  id: eg.string,
  name: eg.string,
  price: eg.number,
  currency: eg.string,
...
export var SelectedZonePlan = eg.object({
  id: eg.string,
  name: eg.string,
  price: eg.number,
  currency: eg.string,
...
export var ZoneUIConfig = eg.object({
  id: eg.string,
  value: eg.any
});
export var AbuseUrl = eg.object({
  id: eg.string,
...
export var ZoneBlock = eg.object({
  id: eg.string,

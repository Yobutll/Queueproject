...
var TransferConditions = eg.object({
  exists: eg.boolean,
...
export var RegistrantContacts = eg.object({
...
export var RegistrationSettings = eg.object({
  auto_renew: eg.boolean,
  privacy: eg.boolean,
  contacts: RegistrantContacts.optional,
  years: eg.number
});
export var DomainFees = eg.object({
  icann_fee: eg.number,
...
export var DomainProtectionStatus = /*#__PURE__*/function (DomainProtectionStatus) {
...
export var DomainExists = eg.object({
  available: eg.boolean
});
export var GetDomainsResult = eg.object({
...
export var DomainSearchResult = eg.object({
...
export var DomainEligibility = eg.object({
  name: eg.string,
...
export var ApproverStatus = /*#__PURE__*/function (ApproverStatus) {
...
export var DesignatedApprover = eg.object({
  email: eg.string,
...
export var DomainProtectionDesignatedApprovers = eg.object({
  designated_approvers: eg.array(DesignatedApprover)
});
export var DomainProtectionConfigStatus = /*#__PURE__*/function (DomainProtectionConfigStatus) {
...
export var DomainProtectionConfig = eg.object({
  auto_relock_after: eg.number,
  number_of_designated_approvers: eg.number,
  status: eg.enum(DomainProtectionConfigStatus)
});
export var DomainProtectionData = eg.intersection([DomainProtectionConfig, DomainProtectionDesignatedApprovers]);
export var DomainProtectionPostResult = eg.object({
  status: eg.number,
  message: eg.string
});
export var ResendDomainProtectionEmailRequest = /*#__PURE__*/function (ResendDomainProtectionEmailRequest) {
...
export var SupportedTLDs = eg.object({
  tlds: eg.array(eg.string)
});
export var DomainUpdateResult = eg.object({
  message: eg.string
});
export var DefaultContactInformation = eg.object({
  result: eg.object({
    entry: eg.object({
      address2: eg.string,
      address: eg.string,

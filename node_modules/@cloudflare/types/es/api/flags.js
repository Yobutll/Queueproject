...
export var AccountFlags = eg.object({
  access: eg.object({
...
export var ZoneFlags = eg.union([AccountFlags, eg.object({
  analytics: eg.object({
...
export var FlagValue = eg.union([eg.boolean, eg.number]);
export var ZoneFlagChange = eg.object({
  id: eg.number,
  status: eg.string,
  feature: eg.string,
  value: eg.boolean,
...
export var AccountFlagChange = eg.object({
  id: eg.number,
  status: eg.string,
  feature: eg.string,
  value: eg.boolean,

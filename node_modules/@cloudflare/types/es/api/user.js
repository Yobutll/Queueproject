...
export var UserDetails = eg.object({
  '2FA-RECOVERY': eg.string
});
export var Dpa = eg.object({
  created_on: eg.string,
  modified_on: eg.string,
  signed_on: eg.string,
...
export var Preference = eg.object({
  subscribed: eg.boolean,
  created_on: eg.string,
  updated_on: eg.string
});
export var UserCommunicationPreferences = eg.object({
  email: eg.object({
    verified: eg.boolean,

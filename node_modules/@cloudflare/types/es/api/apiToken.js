...
export var AccountResource = eg.object({
  accountId: eg.string,
  effect: eg.string,
  rowId: eg.number
});
export var UserResource = eg.object({
  effect: eg.string,
  mode: eg.string,
  rowId: eg.number
});
export var ZoneResource = eg.object({
...
export var ipAddressFilter = eg.object({
  ipAddresses: eg.array(eg.string),
  operator: eg.string,
  rowId: eg.number
});
export var ApiToken = eg.object({
...
export var ApiTokenFormValue = eg.object({
  expires_on: eg.string.optional,
  id: eg.string,
  name: eg.string,
  not_before: eg.string.optional,
...
export var ApiTokensTemplate = eg.object({
  expires_on: eg.string.optional,
  not_before: eg.string.optional,
  key: eg.string,
...
export var ApiTokensAdhocTemplate = eg.object({
  permissionGroupKeys: eg.array(eg.object({
    key: eg.string,
    type: eg.string
  })),
...
export var PermissionGroup = eg.object({
  id: eg.string,
  name: eg.string,
...
export var PermissionGroupReq = eg.object({
  id: eg.string,
  name: eg.string
});
export var CreateToken = eg.object({
  value: eg.string
});
export var PermissionGroups = eg.array(PermissionGroup);
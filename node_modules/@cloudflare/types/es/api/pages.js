...
export var PagesUploadFileResult = eg.object({
  id: eg.string
});
export var Environment = eg.union([eg.literal('preview'), eg.literal('production')]);
export var DeploymentStage = eg.object({
...
export var BuildConfig = eg.object({
...
export var ProjectSourceConfig = eg.object({
  owner: eg.string,
  repo_name: eg.string,
...
export var PlainText = eg.literal('plain_text');
export var SecretText = eg.literal('secret_text');
export var EnvironmentVariableBindingValue = eg.object({
  value: eg.string,
  type: eg.union([PlainText, SecretText]).optional
});
export var EnvironmentVariableBindingMap = eg.record(eg.string, eg.union([EnvironmentVariableBindingValue, eg.null]));
export var NamespaceBindingValue = eg.object({
  namespace_id: eg.string
});
export var DatabaseBindingValue = eg.object({
  id: eg.string
});
export var BucketBindingValue = eg.object({
  name: eg.string
});
export var ServiceBindingValue = eg.object({
  service: eg.string,
  environment: eg.string
});
export var ServiceBindingMap = eg.record(eg.string, ServiceBindingValue);
export var DeploymentConfigEnv = eg.object({
...
export var DeploymentConfigs = eg.record(eg.union([eg.literal('production'), eg.literal('preview')]), DeploymentConfigEnv);
export var Project = eg.object({
  id: eg.string,
  name: eg.string,
  subdomain: eg.string,
...
export var LogMessage = eg.object({
  ts: eg.string,
  line: eg.string
});
...
export var UnifiedDeploymentLogMessages = eg.object({
...
export var DeploymentLiveLogsJWT = eg.object({
  jwt: eg.string
});
...
export var DeploymentLiveLogsJWTPayload = eg.object({
  aud: eg.string,
  exp: eg.number,
  iat: eg.number,
  iss: eg.string,
...
export var DeploymentExistingLiveLogs = eg.object({
  nextIndex: eg.number,
...
export var DirectUploadsJWT = eg.object({
  jwt: eg.string
});
export var UploadFileGroupPayload = eg.object({
  key: eg.string,
  value: eg.string,
  metadata: eg.object({
...
export var PagesTail = eg.object({
  id: eg.string,
  url: eg.string,
  expires_at: eg.string.optional
});
export var PlacementMode = eg.union([eg.literal('off'), eg.literal('smart')]);
export var Placement = eg.object({
  mode: PlacementMode
});
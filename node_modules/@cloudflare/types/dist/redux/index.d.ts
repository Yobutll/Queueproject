 ...
 */
export type ConnectedProps<Connect> = Connect extends InferableComponentEnhancerWithProps<infer P, infer C> ? P : never;
/**
 ...
 */
export type ReducerState<MaybeReducer> = MaybeReducer extends Reducer<infer State, infer Action> ? State : never;
/**

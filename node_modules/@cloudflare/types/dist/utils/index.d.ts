 ...
 */
export type ValueOfArray<T extends Array<any> | ReadonlyArray<any>> = T extends Array<infer U> ? U : T extends ReadonlyArray<infer RO> ? RO : never;
/**
 ...
 */
export type NonReadonly<T extends ReadonlyArray<any>> = T extends ReadonlyArray<infer X> ? X[] : never;
/**
 ...
 */
export type Tail<T extends any[]> = ((...args: T) => any) extends (arg: any, ...args: infer TT) => any ? TT : [];
/**
 * Append T to R where R is a tuple
 */
export type Prepend<T, R extends any[]> = ((t: T, ...rest: R) => any) extends (...tt: infer TT) => any ? TT : never;
/**
 ...
 */
export type Compute<A> = A extends Function ? A : {
    [K in keyof A]: A[K];
} & {};
/**
 ...
 */
export declare function objectKeys<T extends {}>(t: T): (keyof T)[];

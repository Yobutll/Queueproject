...
export type EnvironmentVariableBindingValue = TypeFromCodec<typeof EnvironmentVariableBindingValue>;
...
export type EnvironmentVariableBindingMap = TypeFromCodec<typeof EnvironmentVariableBindingMap>;
...
/** Persistent logs from funfetti */
export type UnifiedDeploymentLogMessages = TypeFromCodec<typeof UnifiedDeploymentLogMessages>;
...
/** Live logs jwt payload for connecting to the live logs durable object */
export type DeploymentLiveLogsJWTPayload = TypeFromCodec<typeof DeploymentLiveLogsJWTPayload>;
...
/** Response from Live Logs (api.pages.cloudflare.com/logs endpoint) to get existing logs over http */
export type DeploymentExistingLiveLogs = TypeFromCodec<typeof DeploymentExistingLiveLogs>;
...
export type UploadFileGroupPayload = TypeFromCodec<typeof UploadFileGroupPayload>;
export declare const FunctionsUsageModel: import("../utils/enumerable").Enumerable<"standard" | "bundled" | "unbound">;
export type FunctionsUsageModel = TypeFromEnumerable<typeof FunctionsUsageModel>;
...
export declare const PlacementMode: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"off">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"smart">>]>>;
export type PlacementMode = TypeFromCodec<typeof PlacementMode>;
export declare const Placement: import("@cloudflare/util-en-garde").ObjectCodec<{
    mode: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"off">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"smart">>]>>;
}>;

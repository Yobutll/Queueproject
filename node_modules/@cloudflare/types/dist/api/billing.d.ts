...
export declare const PaymentMethodType: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"PAYPAL">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"CREDIT_CARD">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"APPLE_PAY">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"GOOGLE_PAY">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"ACH_DIRECT_DEBIT">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"SEPA_DEBIT">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"CASHAPP">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"LINK">>]>>;
...
export declare const PaymentMethod: import("@cloudflare/util-en-garde").ObjectCodec<{
    ...
    type: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"PAYPAL">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"CREDIT_CARD">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"APPLE_PAY">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"GOOGLE_PAY">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"ACH_DIRECT_DEBIT">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"SEPA_DEBIT">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"CASHAPP">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"LINK">>]>>, import("io-ts").UndefinedC]>>;
    last_four: import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>;
    bank_name: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>, import("io-ts").UndefinedC]>>;
    payment_account_email: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>, import("io-ts").UndefinedC]>>;
    cashapp_cash_tag: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>, import("io-ts").UndefinedC]>>;
    expiration_date: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>, import("io-ts").UndefinedC]>>;
    ...
    tax_id_type: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>, import("io-ts").UndefinedC]>>;
    cf_turnstile_response: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>, import("io-ts").UndefinedC]>>;
}>;
...
export type BillableUsageTimeDelta = TypeFromCodec<typeof BillableUsageTimeDelta>;

...
export type ZoneRulesetRewriteRule = TypeFromCodec<typeof ZoneRulesetRewriteRule>;
export type ZoneRulesetRewriteRuleValue = TypeFromCodec<typeof ZoneRulesetRewriteRuleValue>;
export type ZoneRulesetHeaderModificationRuleValue = TypeFromCodec<typeof ZoneRulesetHeaderModificationRuleValue>;
export type ZoneRulesetSanitizeRuleValue = TypeFromCodec<typeof ZoneRulesetSanitizeRuleValue>;
declare const RulesMigration: import("@cloudflare/util-en-garde").ObjectCodec<{
    ...
    is_migrated: import("@cloudflare/util-en-garde").Codec<import("io-ts").BooleanC>;
    migrated_date: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>, import("io-ts").UndefinedC]>>;
}>;

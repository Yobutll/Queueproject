...
export declare const Zone: import("@cloudflare/util-en-garde").ObjectCodec<{
    id: import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>;
    name: import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>;
    versioning: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").ObjectCodec<{
        enabled: import("@cloudflare/util-en-garde").Codec<import("io-ts").BooleanC>;
        isRoot: import("@cloudflare/util-en-garde").Codec<import("io-ts").BooleanC>;
        version: import("@cloudflare/util-en-garde").Codec<import("io-ts").NumberC>;
        rootZoneId: import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>;
    }>, import("io-ts").UndefinedC]>>;
    ...
    type: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"full">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"partial">>, import("@cloudflare/util-en-garde").Codec<import("io-ts").LiteralC<"secondary">>]>>, import("io-ts").UndefinedC]>>;
...
export declare const ZoneBlock: import("@cloudflare/util-en-garde").ObjectCodec<{
    ...
    url_query: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").ArrayC<import("@cloudflare/util-en-garde").ObjectCodec<{
    ...
    url_query_string: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>, import("io-ts").UndefinedC]>>;

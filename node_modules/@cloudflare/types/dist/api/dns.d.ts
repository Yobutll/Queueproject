...
export declare const DNSRecordMeta: import("@cloudflare/util-en-garde").ObjectCodec<{
    ...
    managed_by_web3: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").BooleanC>, import("io-ts").UndefinedC]>>;
...
export declare const DNSFirewallCluster: import("@cloudflare/util-en-garde").ObjectCodec<{
    ...
    upstream_ips: import("@cloudflare/util-en-garde").Codec<import("io-ts").ArrayC<import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>>>;
    origin_ips: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").ArrayC<import("@cloudflare/util-en-garde").Codec<import("io-ts").StringC>>>, import("io-ts").UndefinedC]>>;
    ...
    attack_mitigation: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").ObjectCodec<{
        only_when_origin_unhealthy: import("@cloudflare/util-en-garde").Codec<import("io-ts").UnionC<[import("@cloudflare/util-en-garde").Codec<import("io-ts").BooleanC>, import("io-ts").UndefinedC]>>;
    }>, import("io-ts").UndefinedC]>>;
}>;
...
export type DNSOutgoingZoneTransfers = TypeFromCodec<typeof DNSOutgoingZoneTransfers>;
